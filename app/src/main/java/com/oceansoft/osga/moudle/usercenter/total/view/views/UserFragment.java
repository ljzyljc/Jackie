package com.oceansoft.osga.moudle.usercenter.total.view.views;
...
public class UserFragment extends AbsBaseMapFragment {
    ...
    private void initMainView(View contentView) {
        ...
        view_check_version= (LinearLayout) contentView.findViewById(R.id.view_check_version);
        ...
        view_check_version.setOnClickListener(new View.OnClickListener() {
            @Override
